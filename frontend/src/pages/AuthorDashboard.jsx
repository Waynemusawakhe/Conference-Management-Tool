...
export default function AuthorDashboard() {
  ...
  const submitForm = async (e) => {
    ...
    if (form.file && form.file.type !== "application/pdf") {
      setFormError("Only PDF files are accepted by the current backend contract.");
      return;
    }
