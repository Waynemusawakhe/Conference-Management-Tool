...
export default function Settings() {
  ...
  return <div className="min-h-screen bg-[#07132f] text-white">
    <header className="sticky top-0 z-50 border-b border-white/10 bg-[#07132f]/90 backdrop-blur-xl"><div className="mx-auto flex min-h-[76px] w-[min(1180px,calc(100%-28px))] items-center gap-4"><button onClick={()=>navigate(getDashboardPath(role))} className="grid h-10 w-10 place-items-center rounded-xl border border-white/10 bg-white/5"><ArrowLeft size={17}/></button><Logo/><div className="ml-auto text-right"><p className="m-0 text-[10px] font-extrabold uppercase tracking-[.12em] text-[#aaa2ff]">CMT Settings</p><p className="m-0 text-[10px] text-white/50">Preferences & security</p></div></div></header>
