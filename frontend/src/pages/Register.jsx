  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      navigate("/login", {
        ...
        state: {
          message:
            "Account created successfully. You can now log in. Check your email for the verification link.",
        },
      });
    } catch (requestError) {
        ...
        <div className="relative z-10 mx-auto grid w-[min(1100px,100%)] items-center gap-12 lg:grid-cols-[1.1fr_.9fr]">
          <div className="mx-auto w-full max-w-[470px] rounded-2xl border border-white/15 bg-white p-7 text-[#0d1b3d] shadow-[0_25px_70px_rgba(0,0,0,.3)] sm:p-10">
            ...
            <p className="mt-2 text-xs leading-6 text-[#788398]">
              Register as an author and manage your conference
              submissions.
            </p>
          ...
          <div className="hidden lg:block">
            <span className="inline-flex items-center gap-2 text-[11px] font-extrabold uppercase tracking-[.12em] text-[#b9b3ff]">
              <Sparkles size={15} />
              A better conference workflow
            </span>

            <h2 className="mt-4 max-w-[460px] text-5xl font-bold leading-[1.05] tracking-[-.055em]">
              Make every research opportunity count.
            </h2>

            <p className="mt-5 max-w-[430px] text-sm leading-7 text-white/65">
              Discover events, submit work, connect with peers and
              keep your conference journey moving forward.
            </p>
          </div>
        </div>
      </main>
