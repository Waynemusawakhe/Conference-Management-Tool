  ...
  return (
    <ThemeProvider>
      <Suspense fallback={<div className="grid min-h-screen place-items-center text-sm text-[#66728b]">Loading workspace...</div>}>
        ...
        {/* Reviewer routes are auth-gated: without this the page mounted for
            anonymous visitors and fired an API call that could only 401. */}
        <Route
        ...
        />
        {/* Old capitalised path kept alive so existing links don't break. */}
        <Route path="/ReviewerDashboard" element={<Navigate to="/reviewer-dashboard" replace />} />
